...
% Simple control-sequence labels.
\begin{tikzcd}
	\A & \B
	\arrow[from=1-1, to=1-2]
\end{tikzcd}
...
% Display-math wrapper with ampersand replacement.
...
\begin{tikzcd}
	\bullet & \bullet
	\arrow["\bullet"{marking}, from=1-1, to=1-2]
\end{tikzcd}
...
% Swapping label alignment.
\begin{tikzcd}
	A & B
	\arrow["f"'', swap, from=1-1, swap, to=1-2]
\end{tikzcd}

% `between'
\begin{tikzcd}
	\bullet & \bullet
	\arrow[between={0.3}{0.7}, from=1-1, to=1-2]
\end{tikzcd}

% Shortened marked arrow.
\begin{tikzcd}
	\bullet & \bullet
	\arrow["\shortmid"{marking, pos=0.75}, between={0.5}{1}, from=1-1, to=1-2]
\end{tikzcd}
